...
ALTER TABLE ONLY public.weights
    ADD CONSTRAINT weights_pkey PRIMARY KEY (date, account_id);
...
--
-- Name: weights weights_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weights
    ADD CONSTRAINT weights_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.accounts(id);
...
('20260907090159_split_off_weights_table.rb');
